...
describe('Purchase functionalities', () => {
	...
	it('TC01 - Add 1 itens from category to cart and complete the order' , () => {
		...
		cy.get(SHIPPING.PAYMENT.OrderNumber).invoke('text').then((text) => {
			...
			orderDetails.lastName = testData.lastName;
			orderDetails.postCode = testData.postCode;
	...
	it('TC02 - Add 1 itens from seach to cart and complete the order' , () => {
